...
(function (root) {
  ...
  Sequence.Identity = new Sequence();

  Sequence.Maybe = new Sequence({
    map: function(fn) {
  ...
  Sequence.Callback = new Sequence({
    of: function(value) {
