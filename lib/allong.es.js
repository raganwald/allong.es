...
(function (root) {
  ...
  var Sequence = (function() {
    ...
    Sequence.sequence = variadic( function (sequenceArgs) {
      ...
      if (sequenceArgs.length === 0) {
        ...
        if (sequenceArgs[0] instanceof Sequence) {
          supervisor = sequenceArgs[0];
          ...
          return naiveSequence.apply(this, sequenceArgs);
        }
      }
    });
