...
(function (root) {
  ...
  var nativeIsArray = Array.isArray,
      ...
      isFunction = function (obj) { return obj.toString() == '[object Function]'; };
  ...
  sequence = variadic( function (sequenceArgs) {
    ...
    if (sequenceArgs.length === 0) {
      ...
      if (isFunction(sequenceArgs[0])) {
        ...
        return variadic(arity, function (args) {
          var mapFn = (supervisor.map && supervisor.map.bind(supervisor))     || function (fn) { return fn; },
              chain = (supervisor.chain && supervisor.chain.bind(supervisor)) || function (mValue, fn) { return mapFn(fn)(mValue); },
              of    = (supervisor.of && supervisor.of.bind(supervisor))       || function (value) { return value; }
              
          return fns.reduce(chain, of.apply(this, args));
        });
      }
    }
  });
